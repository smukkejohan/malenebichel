...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Signup.user'
        db.alter_column('courses_signup', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Signup.user'
        raise RuntimeError("Cannot reverse this migration. 'Signup.user' and its values cannot be restored.")
    ...
    models = {
        ...
        'courses.course': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '55', 'db_index': 'True'}),
